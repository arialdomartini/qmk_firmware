...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |       |_ML|ALT|CTL |SFT|   |   |SFT|CTL |ALT|_ML|   |       |    |
   * |------------------------------------------------------------------|
   * |        |  Z|  X|   C|  V|  B|  N|  M|  , |  .|  /|      | Up|    |
   * |------------------------------------------------------------------|
   * |_FL |Win |    |         Space          |App | FN|    |Lef|Dow|Rig |
   * `------------------------------------------------------------------'
   */
[_BL] = KEYMAP_ANSI(
  ...
  TO(_FL), KC_LGUI,      KC_NO  ,                        KC_SPC,                                                             KC_APP,               MO(_FL),            KC_NO   ,        KC_LEFT,             KC_DOWN,  KC_RGHT),
...
[_ML] = KEYMAP_ANSI(
  ...
  _______, _______, _______, _______, _______, _______, _______, KC_PGDN, KC_UP  , KC_PGUP , _______, _______, _______, _______, _______, \
