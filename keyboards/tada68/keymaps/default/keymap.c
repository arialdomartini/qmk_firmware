...
[_BL] = KEYMAP_ANSI(
  ...
  KC_CAPS, LT(_FL,KC_A), MT(MOD_LALT,KC_S),   MT(MOD_LCTL, KC_D),   MT(MOD_LSFT, KC_F),  KC_G,   KC_H,   MT(MOD_RSFT, KC_J), MT(MOD_RCTL,KC_K),    MT(MOD_LALT,KC_L),  LT(_FL,KC_SCLN), KC_QUOT,             KC_ENT ,  KC_NO, \
  KC_NO  , KC_Z,         KC_X,                KC_C,                 KC_V,                KC_B,   KC_N,   KC_M,               KC_COMM,              KC_DOT,             KC_SLSH,         KC_NO  ,             KC_UP  ,  KC_NO, \
  KC_NO  , KC_LGUI,      KC_NO  ,                        KC_SPC,                                                             KC_APP,               MO(_FL),            KC_NO   ,        KC_LEFT,             KC_DOWN,  KC_RGHT),
