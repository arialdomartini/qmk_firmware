...
*/
	...
	[NUMBERS] = LAYOUT(
    _______, _______, _______, _______,  _______,  _______, _______, _______,  _______,  _______, _______, _______, _______, _______, _______,
    _______, KC_GRV,  KC_LCBR, MT(MOD_LGUI, KC_LBRC), KC_LPRN,  KC_EQL,  KC_MINS, KC_RPRN, MT(MOD_RGUI, KC_RBRC),  KC_RCBR, KC_BSLS, _______, _______, _______,
    _______, KC_1,    MY_2,    MY_3,     MY_4 ,    KC_5,    KC_6,    MY_7,     MY_8,     MY_9,    KC_0, _______, _______,
    _______, _______, KC_ESC, _______,  _______,  _______, _______, _______,  _______,  KC_COMM, KC_DOT, _______, _______, _______,
