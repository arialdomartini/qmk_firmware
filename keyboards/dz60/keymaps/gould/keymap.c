...
*/
    ...
    _______, _______, KC_TRNS, KC_TRNS, KC_TRNS, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_QUOT, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_PGUP, KC_CAPS, KC_PGDN, _______, _______, _______,
...
*/
	...
	/* [SYMBOLS] = LAYOUT( */
    /* _______, _______, _______, _______,  _______,  _______, _______, _______,  _______,  _______, _______, _______, _______, _______, _______, */
    /* _______, KC_GRV,  KC_LCBR, MT(MOD_LGUI, KC_LBRC), KC_LPRN,  _______,  _______, KC_RPRN, MT(MOD_RGUI, KC_RBRC),  KC_RCBR, KC_BSLS, _______, _______, _______, */
    /* _______, _______, _______, _______,  _______,  _______, _______, _______, _______,  _______, _______, _______, _______, */
    /* _______, _______, KC_ESC, _______,  _______,  _______, _______, _______,  _______,  _______, _______, _______, _______, _______, */
    /* _______, _______, _______,     KC_BSPC,                 _______,           KC_DEL, _______, _______,  _______,  _______, _______), */


	[SYMBOLS] = LAYOUT(
    _______, _______, _______, _______,  _______,  _______, _______, _______,  _______,  _______, _______, _______, _______, _______, _______,
    _______, KC_TILD, _______, _______,  _______,  _______,  _______,  _______, _______, _______, KC_PIPE, _______,  _______, _______,
    _______, KC_GRV,  KC_LCBR, KC_LBRC, KC_LPRN,  _______, _______, KC_RPRN, KC_RBRC,  KC_RCBR, KC_BSLS, _______, _______,
    _______, _______, KC_ESC, _______,  _______,  _______, _______, _______,  _______,  _______, _______, _______, _______, _______,
    _______, _______, _______,     KC_BSPC,                 _______,           KC_DEL, _______, _______,  _______,  _______, _______),
	...
	[NUMBERS] = LAYOUT(
    _______, _______, _______,  _______,  _______,  _______, _______, _______,  _______,  _______, _______, _______, _______, _______, _______,
    _______, _______, _______,  _______,  _______,  _______, _______, KC_MINS,  KC_PEQL,  KC_PPLS, _______, _______, _______, _______,
    _______, KC_1,    MY_2,     MY_3,     MY_4 ,    KC_5,    KC_6,    MY_7,     MY_8,     MY_9,    KC_0,  _______, _______,
    _______, _______, _______,  _______,  _______,  _______, _______, _______,  KC_UNDS,  KC_COMM, KC_DOT, _______, _______, _______,
