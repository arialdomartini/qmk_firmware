...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------------------------------------------------------------------------------------------|
     * |    |      |     |           Space/Functions      |MyFun|Caps |     |    | Lef | Dow | Rig|
     * `------------------------------------------------------------------------------------------'
     */
    [BASE] = KEYMAP(
    ...
    [EXTR] = KEYMAP(
        ...
        KC_MUTE, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, _______         , KC_MUTE,
