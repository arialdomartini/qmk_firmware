...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |--------------------------------------------------------------------|
   * |Tab  |  Q|  W|    E|  R|  T|  Y|  U|    I|  O|  P|  [|  ]|Backs|Ins |
   * |     |   |   | LGUI|   |   |   |   | RGUI|   |   |   |   |     |    |
   * |--------------------------------------------------------------------|
   ...
   */
    ...
    [_BL] = KEYMAP( \
          ...
          KC_NO  ,KC_NO,        KC_Z,                KC_X,                 KC_C,                KC_V,   KC_B,   KC_N,               KC_M             ,    KC_COMM,             KC_DOT,  KC_SLSH, KC_NO,   KC_UP,          KC_NO,\
    ...
    [_ML] = KEYMAP( \
        ...
        KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_DEL,   KC_NO, KC_BTN1, KC_MS_U, KC_BTN2,\
